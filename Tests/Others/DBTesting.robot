...
*** Variables ***
${DBName}=   robotfwtest
${DBUserName}=     robotfwtest
${DBUserPassword}=   robotfwtest
${DBHost}=     db4free.net
${DBPort}=     3306

*** Test Cases ***
Verify successful creation of table
	[Documentation]     This test case to verify that user is able to create table successfully
	Connect DB
...
*** Keywords ***
Connect DB
    Connect To Database  pymysql  ${DBName}  ${DBUserName}  ${DBUserPassword}  ${DBHost}  ${DBPort}
