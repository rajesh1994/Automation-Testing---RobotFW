...
Verify File Upload
    ...
    Choose File  id:file-upload  /home/stsch0219/PycharmProjects/RobotFramework/Resources/Upload/sunset.jpg
...
Verify File Download
    ...
    ...  download.default_directory=/home/stsch0219/PycharmProjects/Robot-Framework/Resources/Download
    Call Method  ${chrome options}  add_experimental_option  prefs  ${prefs}
    Create Webdriver  Chrome  chrome_options=${chrome options}
    Goto  https://the-internet.herokuapp.com/download
    Click Link  css:[href="download/sunset.jpg"]
    Sleep  5s
    ${files}  List Files In Directory  /home/stsch0219/PycharmProjects/Robot-Framework/Resources/Download
